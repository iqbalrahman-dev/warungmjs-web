...
<body class="bg-gray-100 min-h-screen">
    ...
    <main>
        <div id="home-page" class="container mx-auto p-4">
            <h1 class="text-3xl font-bold text-gray-800 mb-4">Beranda</h1>
                    ...
                    <table class="w-full table-auto text-left">
                        ...
                        <tbody>
                            <?php foreach ($ingredient_purchases as $purchase): ?>
                                <tr class="border-b">
                                    <td class="p-2"><?php echo htmlspecialchars($purchase['name']); ?></td>
                                    <td class="p-2"><?php echo $purchase['quantity']; ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($purchase['price_per_unit'], 2, ',', '.'); ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($purchase['discount'], 2, ',', '.'); ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($purchase['total_cost'], 2, ',', '.'); ?></td>
                                    <td class="p-2">
                    ...
                    <table class="w-full table-auto text-left">
                        ...
                        <tbody>
                            <?php foreach ($product_sales as $sale): ?>
                                <tr class="border-b">
                                    <td class="p-2"><?php echo htmlspecialchars($sale['name']); ?></td>
                                    <td class="p-2"><?php echo $sale['quantity_sold']; ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($sale['price_per_unit'], 2, ',', '.'); ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($sale['discount'], 2, ',', '.'); ?></td>
                                    <td class="p-2">Rp. <?php echo number_format($sale['total_price'], 2, ',', '.'); ?></td>
                                    <td class="p-2">
